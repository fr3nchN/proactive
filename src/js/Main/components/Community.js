                    ...
                    <div className="col-3">
                        <div className="card">
                            ...
                            <div className="card-body text-center">
                                ...
                                <a href={links.external.activeeon.usecases.homeoffice} className="btn btn-outline-secondary" target="_blank">Download</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-3">
                        <div className="card">
                            ...
                            <div className="card-body text-center">
                                ...
                                <a href={links.external.activeeon.usecases.komatsu} className="btn btn-outline-secondary" target="_blank">Download</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-3">
                        <div className="card">
                            ...
                            <div className="card-body text-center">
                                ...
                                <a href={links.external.activeeon.usecases.legalandgeneral} className="btn btn-outline-secondary" target="_blank">Download</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-3">
                        <div className="card">
                            ...
                            <div className="card-body text-center">
                                ...
                                <a href={links.external.activeeon.usecases.cnes} className="btn btn-outline-secondary" target="_blank">Download</a>
                            </div>
                        </div>
                    </div>
                </div>
